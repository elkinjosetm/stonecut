...
describe("renderLocal", () => {
	...
	test("uses 'a structured spec' as task source", async () => {
		...
		expect(result).toContain("You are executing a single task from a structured spec.");
...
describe("renderGithub", () => {
	...
	test("uses 'a GitHub issue' as task source", async () => {
		...
		expect(result).toContain("You are executing a single task from a GitHub issue.");
